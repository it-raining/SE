...
export class TextLayer {
    static "__#52@#ascentCache": Map<any, any>;
    static "__#52@#canvasContexts": Map<any, any>;
    static "__#52@#canvasCtxFonts": WeakMap<object, any>;
    static "__#52@#minFontSize": null;
    static "__#52@#pendingTextLayers": Set<any>;
    ...
    static "__#52@#getCtx"(lang?: null): any;
    static "__#52@#ensureCtxFont"(ctx: any, size: any, family: any): void;
    /**
     * Compute the minimum font size enforced by the browser.
     */
    static "__#52@#ensureMinFontSizeComputed"(): void;
    static "__#52@#getAscent"(fontFamily: any, lang: any): any;
    /**
