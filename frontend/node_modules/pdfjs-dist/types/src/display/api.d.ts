...
export class PDFWorker {
    static "__#56@#fakeWorkerId": number;
    static "__#56@#isWorkerDisabled": boolean;
    static "__#56@#workerPorts": any;
    /**
     * @param {PDFWorkerParameters} params - The worker initialization parameters.
     */
    ...
    static get "__#56@#mainThreadWorkerMessageHandler"(): any;
