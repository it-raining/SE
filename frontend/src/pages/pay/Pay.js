...
function Pay() {
    ...
    const [soDu, setSoDu] = useState(Number(sessionStorage.getItem('current'))); // Số dư ban đầu
    ...
    const handleConfirm = () => {
        ...
        sessionStorage.setItem('current', soDu);
        ...
        <div className="Pay">
            <div className="panel">
                ...
                <div className="info">
                    ...
                    <div id="uid">UID: 2210001</div>
                    <div className="interest">
                        <label id="text">Số lúa khả dụng:</label><br/>
                        <label id="number">{soDu}</label>
